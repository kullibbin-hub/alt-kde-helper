...
- есть глубокая очистка кэшей — в домашнем каталоге, для обычных и Flatpak-приложений, удаление старых журналов и сжатие до размера 100 МБ максимум, очистку кэша пакетов (без применения небезопасной опции autoremove), удаление неиспользуемых рантаймов Flatpak, удаление старых ядер
